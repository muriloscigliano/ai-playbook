...
export default {
  ...
  part: "Part XIII: Production-Hardened Patterns (NEW)",
  problem: "Agents read the same files repeatedly — checking current state before edits, re-reading after modifications, multiple tools reading the same config.",
