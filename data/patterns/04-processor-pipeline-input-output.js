...
export default {
  ...
  part: "Part II: Context Assembly",
  problem: "Between receiving user input and sending it to the LLM, multiple transformations must occur: load history, inject working memory, run guardrails, embed for semantic recall.",
  solution: "Ordered lists of input processors and output processors.",
