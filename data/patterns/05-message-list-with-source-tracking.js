...
export default {
  ...
  part: "Part II: Context Assembly",
  problem: "Messages come from multiple sources (user, LLM, memory recall, system prompts, tools) and need to be in different formats for different providers. Without tracking, you can't debug or optimize.",
