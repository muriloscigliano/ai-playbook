...
export const projectKeywords = {
  chatbot: ['chatbot', 'chat bot', 'conversational', 'customer support', 'support agent', 'helpdesk', 'help desk', 'dialogue', 'virtual assistant', 'support chat'],
  ...
  automation: ['workflow', 'automate', 'automation', 'pipeline', 'process', 'business', 'task', 'orchestrat', 'schedule', 'scheduling', 'booking', 'book meetings', 'calendar', 'appointment', 'generate', 'draft', 'write copy', 'marketing copy', 'content generation', 'detect', 'fraud', 'flag transactions'],
