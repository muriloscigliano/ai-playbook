...
├── ux-patterns/                9 UX pattern metadata files (P1-P9)
├── capabilities/               10 AI capability metadata files
├── vocabulary/                 Human tasks, constraints, touchpoints, AI tasks
├── recommendations/            Project blueprints + problem/UX diagnoses + capability keywords
├── relations/                  Typed relations between entities (incl. capability→pattern)
├── taxonomy/                   Autonomy levels (L1-L4) + visibility levels (V1-V4)
├── helpers/                    Search + detect utilities
└── scripts/                    Migration scripts + validate.js

cli/                            CLI tool — terminal access without MCP
mcp-server/                     MCP server (15 tools) — imports from data/
